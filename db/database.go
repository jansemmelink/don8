...
func init() {
	...
	c := Config{
		...
		Port:           intDefault(os.Getenv("DB_PORT"), 3311),
		Username:       strDefault(os.Getenv("DB_USERNAME"), "don8"),
		Password:       strDefault(os.Getenv("DB_PASSWORD"), "don8"),
		Database:       strDefault(os.Getenv("DB_DATABASE"), "don8"),
